...
class PieChartData
{
  PieChartData(this._categories, this._columns)
  {
    ...
    {
      if (ColumnObject._data.length + 1 != _categories.length) throw new StateError('Each column has to contain same number of values as there are categories. Supplay null value if data is missing for a category!');
    }
  }
